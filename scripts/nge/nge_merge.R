...
# filter out bad quality samples according to the merged reporte
sce <- sce[, sce$manifest != "AD6"]
sce <- sce[, sce$manifest != "NC16"]
sce <- sce[, sce$manifest != "NC11"]
