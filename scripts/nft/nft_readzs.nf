 ...
 */
 ...
 params {
     input = "~/SCADSplice/scrnaseq/nft/metadata/nft_samplesheet.csv"
     useChannels = true
     ...
     isCellranger = false
     runName = "nft_ReadZs"
     metadata = "~/SCADSplice/scrnaseq/nft/metadata/nft_cells_annotation.tsv"
...
params.outdir = "~/SCADSplice/scrnaseq/nft/results/${params.runName}"
params.tracedir = "~/SCADSplice/scrnaseq/nft/results/${params.runName}/pipeline_info"
