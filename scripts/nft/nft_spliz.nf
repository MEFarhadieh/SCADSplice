...
params {
  dataname = "nft"
  input_file = "~/SCADSplice/scrnaseq/nft/results/nft_prespliz.tsv"
  SICILIAN = true
  pin_S = 0.1
  pin_z = 0.0
  bounds = 5
...
params.outdir = "~/SCADSplice/scrnaseq/nft/results/${params.dataname}"
params.tracedir = "~/SCADSplice/scrnaseq/nft/results/${params.dataname}/pipeline_info"
